...
Rectangle {
    ...
    property color borderColor: MonitorThemes.shellColorForItem(root, "colOnLayer0", Appearance.colors.colOnLayer0)
    property real borderRadius: 5
    property real pixelSize: Appearance.font.pixelSize.smaller
    property color keyColor: MonitorThemes.colorForItem(root, "surface_container_low", Appearance.m3colors.m3surfaceContainerLow)
