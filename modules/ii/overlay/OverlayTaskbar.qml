...
Rectangle {
    ...
    component BatteryWidget: Row {
        ...
        Layout.rightMargin: 6
        spacing: 2
        property color colText: Battery.isLowAndNotCharging ? MonitorThemes.shellColorForItem(root, "colError", Appearance.colors.colError) : MonitorThemes.shellColorForItem(root, "colOnSurface", Appearance.colors.colOnSurface)
    ...
    component WidgetButton: RippleButton {
        ...
        contentItem: Item {
            ...
            MaterialSymbol {
                ...
                color: widgetButton.toggled ? MonitorThemes.shellColorForItem(root, "colOnSecondaryContainer", Appearance.colors.colOnSecondaryContainer) : MonitorThemes.shellColorForItem(root, "colOnSurfaceVariant", Appearance.colors.colOnSurfaceVariant)
            }
        }
    }
}
