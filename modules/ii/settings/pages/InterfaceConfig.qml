...
ContentPage {
    ...
    // usage.
    function previewAll() {
        Quickshell.execDetached(["qs", "-p", Quickshell.shellPath(""), "ipc", "call", "mediaTicker", "trigger"])
        Quickshell.execDetached(["qs", "-p", Quickshell.shellPath(""), "ipc", "call", "osdVolume", "trigger"])
