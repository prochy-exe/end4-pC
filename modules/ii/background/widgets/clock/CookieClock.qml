...
Item {
    ...
    property color colBackgroundInfo: ColorUtils.mix(MonitorThemes.shellColorForItem(root, "colPrimary", Appearance.colors.colPrimary), MonitorThemes.shellColorForItem(root, "colPrimaryContainer", Appearance.colors.colPrimaryContainer), 0.55)
    property color colHourHand: MonitorThemes.shellColorForItem(root, "colPrimary", Appearance.colors.colPrimary)
    property color colMinuteHand: MonitorThemes.shellColorForItem(root, "colTertiary", Appearance.colors.colTertiary)
    property color colSecondHand: MonitorThemes.shellColorForItem(root, "colPrimary", Appearance.colors.colPrimary)
